...
export function NewsMediaCard({ image, imageAlt, title, description, date, readMoreHref = '#' }) {
  return (
    <article className="flex h-full w-full flex-col md:mx-auto md:max-w-[441px]">
      ...
      <div className="mt-5 flex items-center justify-between gap-4 pt-1 lg:mt-6">
        ...
        <a className="group inline-flex items-center gap-5" href={readMoreHref}>
